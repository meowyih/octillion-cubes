...
)
{
    ...
    LOG_D(tag_) << "DrawGlyphRun baseline " << baselineOriginX << "," << baselineOriginY;

    // create canvas (range) geometry
    ...
    // pRT_->DrawGeometry(pCanvas, pOutlineBrush_);
    ...
    pRT_->DrawGeometry(pPathGeometry, pOutlineBrush_);
